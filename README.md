...
- Также будет лучше добавить эту строку в `/etc/modprobe.d/i915.conf` для правильной настройки iGPU (графики Arc)
...
- Горячие клавиши на кноках F7, F8, F9 и кнопка PC Manager в правом верхнем углу (ACPI получает события о их нажатии, однако они одинаковые для всех кнопок)
